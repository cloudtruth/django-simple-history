...
class HistoryManager(models.Manager):
    ...
    def as_of(self, date):
        ...
        The resulting queryset will locate the most recent historical record
        before the specified date for each primary key, generating instances.
        If the most recent historical record is a deletion, that instance is
